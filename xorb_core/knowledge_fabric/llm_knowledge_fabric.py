...
from xorb_core.knowledge_fabric.atom import AtomType, KnowledgeAtom, Source
...
from xorb_core.llm.payload_generator import (
    GeneratedPayload,
    PayloadCategory,
    PayloadGenerator,
)
...
class LLMAtom(KnowledgeAtom):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.llm_provenance: LLMProvenance | None = None
        self.payload_data: GeneratedPayload | None = None
...
class LLMKnowledgeFabric(KnowledgeFabric):
    ...
    async def generate_and_store_payloads(
        ...
        from llm.payload_generator import PayloadComplexity, TargetContext
        ...
        for payload in payloads:
            ...
            mock_response = LLMResponse(
                ...
                request_id=f"gen_{int(datetime.now(UTC).timestamp())}"
            )
