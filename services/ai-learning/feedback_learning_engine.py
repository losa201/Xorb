...
class RealTimeIntelligenceLearner:
    ...
    async def should_avoid_action(self, action_context: dict) -> tuple[bool, str | None]:
    ...
    def _actions_similar(self, sig1: str, sig2: str) -> bool:
        ...
        matches = sum(1 for p1, p2 in zip(parts1, parts2, strict=False) if p1 == p2)
        return matches >= 2
    ...
    async def _generate_avoidance_strategy(self, error_sig: str, error: dict) -> dict | None:
