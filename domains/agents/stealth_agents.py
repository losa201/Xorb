...
from .base_agent import AgentCapability, AgentResult, AgentTask, BaseAgent
...
class UserAgentRotator:
    ...
    def __init__(self):
        ...
        self.usage_stats = dict.fromkeys(self.user_agents + self.mobile_user_agents, 0)
...
class StealthPlaywrightAgent(BaseAgent):
    ...
    def __init__(self, agent_id: str, stealth_config: StealthConfig | None = None):
        capabilities = [
