...
class XORBPerformanceBenchmark:
    ...
    def benchmark_domain_imports(self) -> Dict[str, float]:
        ...
        from domains.core import config, Agent, Campaign, AgentType
        ...
        start_time = time.perf_counter()
        from domains.agents.registry import AgentRegistry, AgentCapability
    ...
    def benchmark_configuration_system(self) -> Dict[str, float]:
        ...
        from domains.core.config import config, XORBConfig
    ...
    def benchmark_memory_usage(self) -> Dict[str, float]:
        ...
        import gc
        from domains.core import Agent, Campaign, AgentType
