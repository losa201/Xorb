...
class SessionManager:
    ...
    async def validate_session(self, session_id: str, ip_address: str) -> UserSession | None:
...
class XORBSecurityManager:
    ...
    async def authenticate_user(self,
                               ...
                               password: str,
                               ip_address: str,
                               mfa_token: str | None = None) -> tuple[bool, str | None, str]:
    ...
    async def _validate_mfa(self, username: str, mfa_token: str | None) -> bool:
