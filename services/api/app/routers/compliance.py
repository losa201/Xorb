...
class ComplianceService:
    ...
    async def get_latest_evidence_bundle(self) -> Optional[Dict[str, Any]]:
    ...
    async def get_compliance_report(self, report_date: Optional[str] = None) -> ComplianceReport:
...
async def get_compliance_report(
    report_date: Optional[str] = Query(None, description="Report date in YYYYMMDD format"),
    current_user = Depends(get_admin_user)
):
