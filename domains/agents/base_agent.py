...
class BaseAgent(ABC):
    ...
    async def get_result(self, task_id: str, timeout: float = 30.0) -> AgentResult | None:
    ...
    def _get_capability_for_task(self, task_type: str) -> AgentCapability | None:
        for cap in self.capabilities:
    ...
    async def delegate_task(self, task: AgentTask, preferred_agent_type: AgentType | None = None) -> bool:
    ...
    async def _find_best_agent_for_task(self, task: AgentTask, preferred_type: AgentType | None = None) -> Optional['BaseAgent']:
    ...
    async def _calculate_agent_suitability_score(self, agent: 'BaseAgent', task: AgentTask, preferred_type: AgentType | None) -> float:
