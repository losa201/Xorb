...
class AtomShardManager:
    ...
    def get_shard_config(self, shard_key: str) -> ShardConfig | None:
    ...
    def should_promote_atom(self, atom: KnowledgeAtom, current_tier: ShardTier) -> ShardTier | None:
    ...
    def should_demote_atom(self, atom: KnowledgeAtom, current_tier: ShardTier) -> ShardTier | None:
