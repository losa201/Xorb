...
from ..integrations.openrouter_client import LLMRequest, ModelProvider, OpenRouterClient
from ..knowledge_fabric.atom import AtomType, KnowledgeAtom, Source, ValidationResult
...
class LLMKnowledgeUpdater:
    ...
    async def update_specific_topic(self, topic: str, custom_prompt: str | None = None):
