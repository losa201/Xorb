...
from .atom import AtomType, KnowledgeAtom
...
class GraphAttackPredictor:
    ...
    async def _create_attack_path(self, path_nodes: list[str], entry_points: list[str], target_assets: list[str]) -> AttackPath | None:
