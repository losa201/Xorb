...
class FileSystemDiscoveryPlugin(IAgentDiscoveryPlugin):
    ...
    async def _load_agent_from_file(self, file_path: Path) -> AgentRegistration | None:
...
class AdvancedAgentRegistry:
    ...
    def _find_existing_agent(self, new_agent: AgentRegistration) -> AgentRegistration | None:
    ...
    def get_agent_by_id(self, agent_id: str) -> AgentRegistration | None:
        """Get agent by ID."""
