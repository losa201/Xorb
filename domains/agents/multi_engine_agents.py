...
from .base_agent import AgentCapability, AgentResult, AgentTask, AgentType, BaseAgent
...
class ZAPAgent(BaseAgent):
    ...
    def __init__(self, zap_proxy_port: int = 8080, agent_id: str | None = None, config: dict[str, Any] | None = None):
...
class AgentLoadBalancer:
    ...
    async def assign_task(self, task: AgentTask) -> str | None:
