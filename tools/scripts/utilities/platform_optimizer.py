    ...
    async def generate_optimization_report(self):
        ...
        report = {
            ...
            "next_steps": [
                ...
                "Access dashboard at: kubectl port-forward service/security-dashboard 8080:80 -n xorb_platform",
                "Check API gateway: kubectl port-forward service/simple-api-gateway 8081:8080 -n xorb_platform",
                "View threat intel: kubectl port-forward service/mock-threat-intel 8082:8002 -n xorb_platform",
                "Monitor metrics: kubectl port-forward service/basic-monitoring 9090:9090 -n xorb_platform"
            ]
        }
