...
class XORBServiceAuditor:
    ...
    async def generate_final_recommendations(self):
        ...
        # Quick wins
        print(f"\n⚡ QUICK WINS:")
        print("   1. Fix degraded Kubernetes services with: kubectl rollout restart deployment/<name> -n xorb_platform")
        print("   2. Access working dashboard: kubectl port-forward service/security-dashboard 8080:80 -n xorb_platform")
        print("   3. Check API gateway: kubectl port-forward service/simple-api-gateway 8081:8080 -n xorb_platform")
        print("   4. Monitor basic metrics: kubectl port-forward service/basic-monitoring 9090:9090 -n xorb_platform")
