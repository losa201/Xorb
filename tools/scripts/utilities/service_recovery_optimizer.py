...
"""
    ...
    async def generate_access_guide(self):
        ...
        access_guide = {
            ...
            "access_methods": {
                "local_access": [
                    "kubectl port-forward service/security-dashboard 8080:80 -n xorb-platform",
                    "kubectl port-forward service/simple-api-gateway 8081:8080 -n xorb-platform",
                    "kubectl port-forward service/working-security-api 8001:8001 -n xorb-platform",
                    "kubectl port-forward service/working-analytics 8003:8003 -n xorb-platform",
                    "kubectl port-forward service/prometheus 9090:9090 -n xorb-platform",
                    "kubectl port-forward service/grafana 3000:3000 -n xorb-platform"
                ],
                "service_urls": {
            ...
            "health_checks": [
                ...
                "kubectl logs -f deployment/working-security-api -n xorb-platform"
            ]
        }
...
async def main():
    ...
    try:
        ...
        print("  Dashboard:     kubectl port-forward service/security-dashboard 8080:80 -n xorb-platform")
        print("  API Gateway:   kubectl port-forward service/simple-api-gateway 8081:8080 -n xorb-platform")
        print("  Security API:  kubectl port-forward service/working-security-api 8001:8001 -n xorb-platform")
        print("  Analytics:     kubectl port-forward service/working-analytics 8003:8003 -n xorb-platform")
        print("  Prometheus:    kubectl port-forward service/prometheus 9090:9090 -n xorb-platform")
        print("  Grafana:       kubectl port-forward service/grafana 3000:3000 -n xorb-platform")
