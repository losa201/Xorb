...
class Orchestrator:
    ...
    async def create_campaign(self, name: str, targets: list[dict], priority: CampaignPriority = CampaignPriority.MEDIUM, metadata: dict | None = None) -> str:
    ...
    async def list_campaigns(self, status_filter: CampaignStatus | None = None) -> list[dict]:
        campaigns = []
