...
from xorb_core.hunting.ai_threat_hunter import (
    AIThreatHunter, ThreatHypothesis
)
...
class AIThreatHuntingDemo:
    ...
    def generate_network_telemetry(self) -> List[Dict[str, Any]]:
        ...
        for i in range(1000):
            event = {
                ...
                "connection_state": random.choice(["ESTABLISHED", "CLOSED", "SYN_SENT"])
            }
            events.append(event)
    ...
    async def demonstrate_anomaly_detection(self):
        ...
        for anomaly in statistical_anomalies[:3]:
            ...
            print(f"        Deviation: {anomaly.get('deviation', 0):.2f} standard deviations")
    ...
    async def demonstrate_active_hunting(self):
        ...
        for finding in findings[:3]:
            ...
            print(f"      Affected Assets: {len(finding.get('affected_assets', []))} hosts")
    ...
    async def demonstrate_threat_correlation(self):
        ...
        iocs = [
            ...
            {"type": "hash", "value": "d41d8cd98f00b204e9800998ecf8427e", "source": "VirusTotal"},
            {"type": "domain", "value": "malicious-domain.evil", "source": "Emerging Threats"}
        ]
        ...
        for ioc in iocs:
            ...
            threat_data = {
                ...
                "threat_types": random.sample(["Malware", "C&C", "Phishing", "Botnet"], 2),
