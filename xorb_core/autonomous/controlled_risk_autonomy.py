...
from .episodic_memory_system import EpisodeType
...
class ControlledRiskAutonomy:
    ...
    def _calculate_risk_trend(self, previous: RiskLevel | None, current: RiskLevel) -> str: return "stable"
    ...
    async def _check_roe_compliance(self, activity: dict[str, Any]) -> OutboundRuleViolation | None: return None
