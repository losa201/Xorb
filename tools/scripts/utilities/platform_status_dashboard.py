...
class XORBPlatformMonitor:
    ...
    async def generate_recommendations(self):
        ...
        standard_recommendations = [
            "📊 Monitor service logs: kubectl logs -f deployment/<service-name> -n xorb_platform",
            "🔍 Check service events: kubectl describe pod <pod-name> -n xorb_platform",
            "🚀 Scale services if needed: kubectl scale deployment <name> --replicas=3 -n xorb_platform",
            "🔄 Restart problematic services: kubectl rollout restart deployment/<name> -n xorb_platform",
