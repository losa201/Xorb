...
class AdvancedMetricsManager:
    ...
    @contextmanager
    def measure_duration(self, metric_name: str, labels: dict[str, str] | None = None):
    ...
    def record_business_metric(self, name: str, value: float, labels: dict[str, str] | None = None):
