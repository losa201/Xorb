...
class Settings:
    ...
    database_url: str = field(default_factory=lambda: os.getenv("DATABASE_URL", "postgresql://localhost/xorb"))
    ...
    azure_sso_enabled: bool = field(default_factory=lambda: os.getenv("AZURE_SSO_ENABLED", "false").lower() == "true")
    ...
    azure_tenant: str = field(default_factory=lambda: os.getenv("AZURE_TENANT", "common"))
    
    # SSO Configuration - Google
    google_sso_enabled: bool = field(default_factory=lambda: os.getenv("GOOGLE_SSO_ENABLED", "false").lower() == "true")
    ...
    okta_sso_enabled: bool = field(default_factory=lambda: os.getenv("OKTA_SSO_ENABLED", "false").lower() == "true")
    okta_client_id: str = field(default_factory=lambda: os.getenv("OKTA_CLIENT_ID", ""))
    okta_client_secret: str = field(default_factory=lambda: os.getenv("OKTA_CLIENT_SECRET", ""))
    okta_domain: str = field(default_factory=lambda: os.getenv("OKTA_DOMAIN", ""))
    
    # SSO Configuration - GitHub
    github_sso_enabled: bool = field(default_factory=lambda: os.getenv("GITHUB_SSO_ENABLED", "false").lower() == "true")
