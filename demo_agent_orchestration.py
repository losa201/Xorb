...
class XORBOrchestrationDemo:
    ...
    def demo_agent_discovery(self):
        ...
        try:
            from domains.agents.registry import AgentRegistry, AgentCapability, AgentDefinition
    ...
    def demo_campaign_planning(self, registry):
        ...
        try:
            from domains.core import Campaign, Target, CampaignStatus, AgentType
            ...
            for agent_type in campaign.agent_requirements:
                ...
                if available_agents:
                    ...
                    self.print_warning(f"No agents available", f"Type: {agent_type.value}")
    ...
    def print_demo_summary(self):
        ...
        print(f"   🤖 Agent Types: Reconnaissance, Vulnerability Assessment, Threat Hunting")
        print(f"   🎭 Campaign Management: Multi-target, multi-agent coordination")
        print(f"   ⚡ Async Execution: Concurrent agent operations")
        print(f"   📊 Monitoring: Performance profiling and metrics")
